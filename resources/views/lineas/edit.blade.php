            ...
            <div class="col s12 m12 l12">
                <div class="row">
                    ...
                    <div class="col s4 m4 l2 rigth-align">
                        <ol class="breadcrumbs">
                            ...
                            <li><a href="{{route('lineas.index')}}">Lineas Tecnológicas</a></li>
                ...
                <div class="card stats-card">
                    <div class="card-content">
                        <div class="row">
                            <div class="row">
                                <center><span class="card-title center-align">Editar Linea <b>{{$linea->nombre}}</b></span> <i class="Small material-icons">dns </i></center>
