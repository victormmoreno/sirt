		...
		<div class="container">
            <div class="row  no-m-t no-m-b">
                ...
                <div class="col s12 m12 l12 ">
                    ...
                    <ul>
                        <li>🔶 La información que registra es verídica, real y corresponde a sus datos personales.</li>
                        <li>🔶 El usuario y la contraseña asignados son de carácter intransferible, personal y modificable únicamente por su titular.</li>
                        <li>🔶 La suplantación o ingreso de información falsa constituye un fraude el cual implica sanciones e inhabilidades.</li>
                        <li>🔶 Es responsabilidad del usuario mantener la información actualizada: Tipo y número de identificación, lugar de expedición del documento, nombres y apellidos, fecha de nacimiento dirección de residencia, números de teléfono de contacto, correo electrónico, últimos estudios y ocupaciones.</li>
                        <li>🔶 Es una acción irregular registrarse en nuestro sistema RED TECNOPARQUE COLOMBIA varias veces con datos inconsistentes, y/o documentos de identificación vencidos o irreales.</li>
                    ...
                    <ul>
                        ...
                        <li>🔶 Reportes estadísticos de ejecución de los procesos de la Red Tecnoparque Colombia y otras entidades gubernamentales que lo soliciten.</li>
                        <li>🔶 Intercambio de información con entidades de seguridad, control y veeduría del Estado.</li>
                    </ul>
