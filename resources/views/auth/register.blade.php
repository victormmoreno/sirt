                    ...
                    <div class="col s12 m12 l12 ">
                        ...
                        <ul class="collapsible">
                            <li>
                                ...
                                <div class="collapsible-body"><p>Registrarse es el primer paso para inscribirse a los
                        ...
                        <div class="content">
                            <form id="formRegisterUser" method="POST" action="{{ route('register.request') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m6 vertical-line">
                                        ...
                                        <div class="row">
                                            <div class="input-field col m6 s12">
                                                ...
                                                <label for="txttipo_documento">Tipo Documento <span
                                        ...
                                        <div class="row">
                                            <div class="input-field col m6 s12">
                                                <select class="js-states browser-default select2 "
                                                        id="txtdepartamentoexpedicion" name="txtdepartamentoexpedicion"
                                                        onchange="user.getCiudadExpedicion()" style="width: 100%"
                                                        tabindex="-1">
                                                ...
                                                <label class="active" for="txtdepartamentoexpedicion">Departamento de
                                            ...
                                            <div class="input-field col m6 s12">
                                                <select class="js-states browser-default select2"
                                                        id="txtciudadexpedicion" name="txtciudadexpedicion"
                                                        style="width: 100%" tabindex="-1">
                                                    <option value="">Seleccione Primero el Departamento</option>
                                                </select>
                                                <label class="active" for="txtciudadexpedicion">Ciudad de Expedición
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input class="validate" id="txtemail" name="txtemail" type="email"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input class="validate" id="txtcelular" name="txtcelular" type="tel"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select class="js-states browser-default select2" id="txtdepartamento"
                                                        name="txtdepartamento" onchange="user.getCiudad()"
                                                        style="width: 100%" tabindex="-1">
                                                    <option value="">Seleccione departamento</option>
                                                    @foreach($departamentos as $value)
                                                ...
                                                <label class="active" for="txtdepartamento">Departamento de Residencia
                                                    <span class="red-text">*</span></label>
                                                <small id="txtdepartamento-error" class="error red-text"></small>
                                            </div>
                                            <div class="input-field col s12 m6 l6">
                                                <select class="js-states browser-default select2" id="txtciudad"
                                                        name="txtciudad" style="width: 100%" tabindex="-1">
                                                    <option value="">Seleccione Primero el Departamento</option>
                                                </select>
                                                <label class="active" for="txtciudad">Ciudad de Residencia <span
                                                        class="red-text">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <input class="validate" id="txtbarrio" name="txtbarrio" type="text"
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input class="validate" id="txtdireccion" name="txtdireccion"
                                                       type="text"
                                    ...
                                    <div class="col m6 l6">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input class="validate" id="txtapellidos" name="txtapellidos"
                                                       type="text"
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input class="validate datepicker" id="txtfecha_nacimiento"
                                                ...
                                                <label for="txtfecha_nacimiento">Fecha de Nacimiento <span
                                                        class="red-text">*</span></label>
                                                <small id="txtfecha_nacimiento-error" class="error red-text"></small>
                                            </div>
                                            <div class="input-field col s12 m6 l6">
                                                <select class="js-states browser-default select2" id="txtgruposanguineo"
                                                        name="txtgruposanguineo" style="width: 100%" tabindex="-1">
                                                ...
                                                <label class="active" for="txtgruposanguineo">Grupo Sanguíneo <span
                                                        class="red-text">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select id="txtestrato" name="txtestrato" style="width: 100%"
                                                        tabindex="-1">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <select class="js-states browser-default select2" id="txtetnias"
                                                        name="txtetnias" style="width: 100%" tabindex="-1">
                                                    <option value="">Seleccione Etnia</option>
                                                    @foreach($etnias as $id => $nombre)
                                                        @if(isset($user->etnia->id))
                                                            <option
                                                                value="{{$id}}" {{old('txtetnias',$user->etnia->id) ==$id ? 'selected':($nombre =='No aplica' ? 'selected': '')}} >{{$nombre}}</option>
                                                        @else
                                                            <option
                                                                value="{{$id}}" {{old('txtetnias') ==$id ? 'selected': ($nombre =='No aplica' ? 'selected': '')}}>{{$nombre}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                <label class="active" for="txtetnias">Etnias <span
                                                        class="red-text">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select class="js-states browser-default select2" id="txteps"
                                                        name="txteps" style="width: 100%" tabindex="-1"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select class="" id="txtgrado_discapacidad" name="txtgrado_discapacidad"
                                                        style="width: 100%" tabindex="-1"
                                                ...
                                                <label for="txtgrado_discapacidad">Algún grado de discapacidad <span
                                                        class="red-text">*</span></label>
                                                <small id="txtgrado_discapacidad-error" class="error red-text"></small>
                                            </div>
                                            <div class="input-field col s12 m6 l6 gradodiscapacidad"
                                                 style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select class="" id="txtmadrecabezafamilia" name="txtmadrecabezafamilia"
                                                        style="width: 100%" tabindex="-1">
                                                    @if(isset($user->mujerCabezaFamilia))
                                                        <option
                                                            {{$user->mujerCabezaFamilia == 0 ?'selected' : ''}} value="0">
                                                            NO
                                                        </option>
                                                        <option
                                                            {{$user->mujerCabezaFamilia == 1 ?'selected' : ''}} value="1">
                                                            SI
                                                        </option>
                                                    @else
                                                        <option value="0">NO</option>
                                                ...
                                                <label for="txtmadrecabezafamilia">¿Madre Cabeza de familia?<span
                                                        class="red-text">*</span></label>
                                                <small id="txtmadrecabezafamilia-error" class="error red-text"></small>
                                            </div>
                                            <div class="input-field col s12 m6 l6">
                                                <select class="" id="txtdesplazadoporviolencia"
                                                        name="txtdesplazadoporviolencia" style="width: 100%"
                                                        tabindex="-1">
                                                    @if(isset($user->mujerCabezaFamilia))
                                                        <option
                                                            {{$user->mujerCabezaFamilia == 0 ?'selected' : ''}} value="0">
                                                ...
                                                <label for="txtdesplazadoporviolencia">¿Desplazado(a) por
                                                    violencia?<span class="red-text">*</span></label>
                                                <small id="txtdesplazadoporviolencia-error"
                                                       class="error red-text"></small>
                                            </div>
                                        </div>
                                        <div class="row center">
                                            <div class="input-field col s12 m12 l12 ">
                                                ...
                                                <div class="switch m-b-md">
                                                    ...
                                                    <p class="no-p-v">
                                                        <input class="with-gap " name="txtgenero" type="radio"
                                                               id="masculino"
                                                               value="1" {{isset($user->genero) && $user->genero == 1 ? 'checked' : 'checked'}}>
                                                        <label for="masculino" class="p-h-md">Masculino</label>
                                                        <input class="with-gap" t name="txtgenero" type="radio"
                                                               id="femenino"
                                                ...
                                                <div class="input-field col s12 m6 l6 ">
                                                    <select class="" id="txtgrado_escolaridad"
                                                        ...
                                                        @foreach($gradosescolaridad as $value)
                                                            ...
                                                            @else
                                                                <option
                                                                    value="{{$value->id}}" {{old('txtgrado_escolaridad') ==$value->id ? 'selected':''}}>{{$value->nombre}}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                        ...
                                                        <div class="input-field col s12 m8 l8 offset-l3 m-3">
                                                            <select class="js-states browser-default  selectMultipe"
                                                                ...
                                                                @foreach($ocupaciones as $id => $nombre)
                                                                    ...
                                                                    @else
                                                                        <option
                                                                            {{collect(old('txtocupaciones'))->contains($id) ? 'selected' : ''  }}  value="{{$id}}">{{$nombre}}</option>
                                                                    @endif
                                                                @endforeach
                                                            </select>
                                ...
                                <div class="row center">
                                    <div class="col s12 m12 l12">
                                        <div class="divider mailbox-divider"></div>
                                        <h5 class="center-align primary-text">Tipo de usuario</h5>
                                        <p class="p-v-xs">
                                            <input checked="" class="txttipousuario" id="txttalento"
                                                   name="txttipousuario" type="radio" value="talento"
                                                   onchange="user.checkedTypeUser()" {{ isset($idea->pregunta1) && $idea->pregunta1 == 1 ? 'checked' : (old('pregunta1') == 1 ? 'checked':'')}}/>
                                            <label align="justify" for="txttalento" class="black-text text-black">
                                                Deseo presentar una idea de proyecto.
                                            </label>
                                        </p>
                                        <p class="p-v-xs">
                                            <input class="txttipousuario" id="txtcontratista" name="txttipousuario"
                                                   type="radio" value="contratista"
                                                   onchange="user.checkedTypeUser()" {{ isset($idea->pregunta2) && $idea->pregunta2 == 2 ? 'checked' : (old('pregunta2') == 2 ? 'checked':'')}}/>
                                ...
                                <div class="row talento">
                                    <div class="col s12 m8 l8 offset-l2 offset-m2">
                                        <h5 class="center-align primary-text">
                                            Información talento</h5>
                                        <div class="divider mailbox-divider"></div>
                                        <div class="row">
                                            <div class="input-field col s12 m4 l4 ">
                                                <select
                                                    class="js-states browser-default select2 select2-hidden-accessible"
                                                    id="txttipotalento" name="txttipotalento" style="width: 100%"
                                                    tabindex="-1" onchange="tipoTalento.getSelectTipoTalento(this)">
                                                    @if(isset($user->talento->tipotalento->id) && ((session()->get('login_role') == App\User::IsAdministrador() || session()->get('login_role') == App\User::IsDinamizador())))
                                                        <option value="{{$user->talento->tipotalento->id}}"
                                                                selected>{{$user->talento->tipotalento->nombre}}</option>
                                                    @else
                                                        <option value="">Seleccione tipo de talento</option>
                                                        @foreach($tipotalentos as $id => $nombre)
                                                            @if(isset($user->talento->tipotalento->id))
                                                                <option
                                                                    value="{{$id}}" {{old('txttipotalento',$user->talento->tipotalento->id) ==$id ? 'selected':''}}>{{$nombre}}</option>
                                                            @else
                                                                <option
                                                                    value="{{$id}}" {{old('txttipotalento') ==$id ? 'selected':''}}>{{$nombre}}</option>
                                                            @endif
                                            ...
                                            <div class="input-field col s12 m8 l8">
                                                <div class="row">
                                                    <div
                                                        class="input-field col s12 m12 l12 valign-wrapper selecttipotalento"
                                                        style="display:block">
                                                ...
                                                <div class="row aprendizSena" style="display:none">
                                                    <div class="input-field col s12 m12 l12">
                                                        <select
                                                            ...
                                                            style="width: 100%" tabindex="-1"
                                                            onchange="tipoTalento.getCentroFormacionAprendiz()">
                                                        ...
                                                        <label for="txtregional_aprendiz" class="active">Regional <span
                                                                class="red-text">*</span></label>
                                                        <small id="txtregional_aprendiz-error"
                                                               class="error red-text"></small>
                                                    </div>
                                                    <div class="input-field col s12 m12 l12">
                                ...
                                <div class="row contratista">
                                    <div class="col s12 m8 l8 offset-l2 offset-m2">
                                        <h5 class="center-align primary-text">
                                            Información funcionario Red Tecnoparque Colombia</h5>
                                        <div class="divider mailbox-divider"></div>
                                        <div class="row">
                                            <div class="input-field col s12 m8 l8 offset-l2 offset-m2">
                                                <select
                                                    class="js-states browser-default select2 select2-hidden-accessible"
                                                    id="txtnodo" name="txtnodo" style="width: 100%" tabindex="-1">
                                                    <option value="">Seleccione Nodo</option>
                                                    @foreach($nodos as $id => $nodo)
                                                        <option
                                                            value="{{$id}}" {{old('txtnodo') ==  $id ? 'selected':''}}>{{$nodo}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="input-field col s12 m8 l8 offset-l4 offset-m4">
                                                <p class="p-v-xs">
                                                    <input checked="" class="txttipocontratista" id="txtcontratistas"
                                                           name="txttipocontratista" type="radio"
                                                           value="planta" {{ old('pregunta1') == 'planta' ? 'checked':''}}/>
                                                    <label align="justify" for="txtcontratistas"
                                                           class="black-text text-black">
                                                        Contratista.
                                                    </label>
                                                    <input class="txttipocontratista" id="txtplanta"
                                                           name="txttipocontratista" type="radio"
                                                           value="contratista" {{ old('pregunta1') == 'contratista' ? 'checked':''}}/>
                                                    <label align="justify" for="txtplanta"
                                                           class="black-text text-black">
                                                        Planta.
                                                    </label>
                                                </p>
                                        ...
                                        <div class="col-md-6 offset-md-4">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label black-text text-black" for="txtremember">
                                                    Acepto los <a
                                                        class="m-t-sm secondary-text center-align"
                    ...
                    <div class="row">
                        <div class="input-field col m12 s12 l12">
                            <select name="document_type" style="width: 100%" tabindex="-1">
                                ...
                                @foreach($tiposdocumentos as $value)
                                    <option
                                        value="{{$value->id}}" {{old('document_type') == $value->id  ? 'selected':''}}>{{$value->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="input-field col l12 m12 s12">
                            <input id="document" name="document" type="text"
                                   value="{{isset($documento) ? $documento : ''}}" {{isset($documento) ? 'readonly' : ''}}>
