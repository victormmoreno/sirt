...
@section('content')
    @php
        $class = 'm12 l12';
    @endphp
    @canany(['cargar_evidencias', 'edit', 'calificar', 'notificar_comite', 'asignar_ideas'], [$comite,
        $comite->ideas->first()])
        @php
            $class = 'm8 l8';
        @endphp
                ...
                <div class="col s12 m12 l12">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <br>
                            <center>
                                <span class="card-title center-align">Comité - {{ $comite->codigo }}
                                    <b>({{ $comite->estado->nombre }})</b></span>
                            </center>
                            <div class="divider"></div>
                            <div class="row">
                                @canany(['cargar_evidencias', 'edit', 'calificar', 'notificar_comite', 'asignar_ideas'],
                                    [$comite, $comite->ideas->first()])
                            ...
                            <div class="row">
                                <table class="display responsive-table datatable-example dataTable" style="width: 100%"
                                    id="archivosDelComiteDinamizadorGestorAdministador">
                                    <thead>
                                        <tr>
                                            <th>Archivo</th>
