                ...
                <div class="col s12 m12 l12">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <br>
                            <center>
                                <span class="card-title center-align">Editar Comité de Selección de Ideas -
                                    <b>{{ $comite->codigo }}</b></span>
                            </center>
                            <div class="divider"></div>
                            <div class="row">
                                <form action="{{ route('csibt.agendamiento.update', $comite->id) }}"
                                    id="formComiteAgendamientoUpdate" method="post">
                                    {!! method_field('PUT') !!}
