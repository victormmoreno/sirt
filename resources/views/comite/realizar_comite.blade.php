                ...
                <div class="col s12 m12 l12">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <br>
                            <center>
                                <span class="card-title center-align">Realizar Comité de Selección de Ideas -
                                    <b>{{ $comite->codigo }}</b></span>
                            </center>
                            <div class="divider"></div>
                            <div class="row">
                                <form action="{{ route('csibt.realizar.store', $comite->id) }}"
                                    id="formComiteRealizadoCreate" method="post">
                                    {!! method_field('PUT') !!}
