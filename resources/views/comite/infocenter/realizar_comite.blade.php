...
@push('script')
    <script>
        function setEstadoIdeaProyecto(id) {
        ...
        function validarAdmitido(idIdea, idAdmitido, estado) {
            ...
            if ( $('#txtadmitidos' + idIdea).is(":checked") ) {
                $('#txtestadoidea' + idIdea).append('<option  value="'+idAdmitido+'">'+estado+'</option>');
                $('#txtestadoidea' + idIdea).val(idAdmitido);
                ...
                @foreach ($estados as $key => $item)
                    ...
                    $('#txtestadoidea'+ idIdea).append('<option value="{{$item->id}}">{{$item->nombre}}</option>');
                    @endif
                @endforeach
                $('#txtestadoidea' + idIdea).material_select();
            }
