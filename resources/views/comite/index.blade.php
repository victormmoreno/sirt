        ...
        <div class="content">
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div
                                            class="col s12 {{ request()->user()->can('create', App\Models\Comite::class)? 'm10 l10': 'm12 l12' }}">
                                    ...
                                    @can('show_filters', App\Models\Comite::class)
                                        <div class="row">
                                            <div class="input-fiel">
                                                <label class="active" for="txtnodo">Nodo <span
                                                        class="red-text">*</span></label>
                                                <select class="initialized" id="txtnodo" name="txtnodo" style="width: 100%"
                                                    tabindex="-1" onchange="consultarCsibtPorNodo()">
                                    ...
                                    <table class="display responsive-table datatable-example dataTable"
                                        id="comitesDelNodo_table" style="width: 100%">
                                        <thead>
                                            <tr>
            ...
            @can('create', App\Models\Comite::class)
                <div class="fixed-action-btn show-on-medium-and-down hide-on-med-and-up">
                    <a href="{{ route('csibt.create') }}" class="btn btn-floating btn-large tooltipped green"
                        data-position="left" data-delay="50" data-tooltip="Nuevo Comité">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#comitesDelNodo_table').DataTable({
                    ...
                    order: false,
                    ajax: {
                        url: host_url + "/csibt/" + {{ request()->user()->getNodoUser() }} +
                            "/consultarCsibtPorNodo",
                        type: "get",
                    },
                    columns: [{
                            data: 'codigo',
