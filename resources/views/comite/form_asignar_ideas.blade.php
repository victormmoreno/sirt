                            ...
                            <td>
                                ...
                                <select id="txtgestor_id{{ $value->id }}" class="js-states browser-default select2"
                                    ...
                                    @if ($value->pivot->admitido == 1)
                                        <option value="">Seleccione el experto a cargo de la idea de proyecto
                                        </option>
                                        @foreach ($gestores as $id => $gestor)
                                            <option value="{{ $gestor->gestor->id }}">{{ $gestor->documento }} -
                            ...
                            <td>
                                @if ($value->pivot->admitido == 1)
                                    <a href="javascript:void(0)"
                                        onclick="confirmacionDuplicidad( event, '{{ route('idea.derivar', [$value->id, $comite->id]) }}' )">
