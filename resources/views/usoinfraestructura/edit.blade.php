...
<script>
    $(document).ready(function() {
        ...
        @endif
        @if(isset($usoinfraestructura->asesorable->articulacionpbt))
            usoInfraestructuraUpdate.getSelectTalentoArticulacion({{$usoinfraestructura->asesorable->articulacionpbt->id}});
        @endif
	});
