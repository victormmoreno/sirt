...
la aprobación para cancelar la {{__('articulation')}} {{$notification->notificable->present()->articulationName()}}.
<br>
...
@component('mail::button', ['url' => route('articulations.cancel',  $notification->notificable)])
🔗 Ir a la página para cancelar
@endcomponent
