                                ...
                                <div class="col s12 m12 l12">
                                    <div class="mailbox-view">
                                            ...
                                            <div class="left">
                                                <div class="left">
                                                    ...
                                                    <span class="mailbox-author">
                                                        ...
                                                        <b class="secondary-text">Estado: </b>
                                                        {{ (isset($nodo->estado) && $nodo->estado == 1)  ? 'Activo' : 'Inactivo' }}<br />
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="right mailbox-buttons hide-on-med-and-down">
                                                <span class="mailbox-title">
                                                    <p class="center">Información Tecnoparque
                                        ...
                                        <div class="right hide-on-med-and-down">
                                            @can('uploadFiles', $nodo)
                                                <small class="info-text">
                                                    <a href="{{ route('nodo.upload-files', $nodo->entidad->slug) }}"
                                                        ...
                                                        ({{ $nodo->model()->whereYear('created_at', $year)->count() }})
                                                    </a>
                                                </small>
                                            @endcan
                                            ...
                                            @endcan
                                            @can('changeStatus', $nodo)
                                            <small class="info-text">
                                                {{-- <a href="#"
                                                    class="waves-effect waves-black btn-flat">
                                                    <i class="fas fa-toggle-on fa-lg"></i> Cambiar estado
                                                </a> --}}
                                                <a href="#" class="waves-effect waves-black btn-flat" onclick="nodo.changeStatus({{$nodo->id}})" data-position="bottom" data-delay="50" data-tooltip="Cambiar Estado">
                                                    <i class="fas fa-toggle-on fa-lg"></i> Cambiar estado</a>
                                            </small>
                                            @endcan
                                            @can('edit', $nodo)
                                                <small class="info-text">
                                                ...
                                                <div class="col s12 m4 l3 ">
                                                    <ul class="collection with-header">
                                                        <li class="collection-header center ">
                                                            <h5 class="primary-text"><b>Lineas Tecnológicas
                                                                    ({{ $nodo->lineas->count() }})</b></h5>
                                                        </li>
                                                        @forelse($lineatecnologicas as $value)
                                                            <li class="collection-item">
                                                                ...
                                                                <a href="{{ route('lineas.show', $value->slug) }}"
                                                                    target="_blank" class="info tooltipped"
                                                                    data-position="bottom"
                                                                    data-tooltip="Ver más información">
                                                ...
                                                <div class="col s12 m8 l9">
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 m12 l6">
                                                            <div class="center">
                                                                <span class="secondary-text"><b>{{ App\User::IsDinamizador() }}
                                                                    </b></span>
                                                            </div>
                                                            <ul class="collection">
                                                                @forelse($nodo->dinamizadores as $dinamizador)
                                                                    @if (isset($dinamizador->user) &&
                                                                            $dinamizador->user->hasRole(App\User::IsDinamizador()) &&
                                                                            $dinamizador->user->estado == App\User::IsActive() &&
                                                                            $dinamizador->user->deleted_at == null)
                                                                        <li class="collection-item">
                                                                            <span class="title">
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <br />
                                                                                <b class="secondary-text">Teléfono:</b>
                                                                                {{ $dinamizador->user->present()->userTelefono() }}
                                                                                <br />
                                                                            ...
                                                                            @can('show', $dinamizador->user)
                                                                                <a target="_blank"
                                                                                    href="{{ route('usuario.show', $dinamizador->user->documento) }}"
                                                                                    class="info">
                                                            ...
                                                            <ul class="collection">
                                                                @forelse($nodo->infocenters as $infocenter)
                                                                    @if (isset($infocenter->user) &&
                                                                            $infocenter->user->hasRole(App\User::IsInfocenter()) &&
                                                                            $infocenter->user->estado == App\User::IsActive() &&
                                                                            $infocenter->user->deleted_at == null)
                                                                        <li class="collection-item">
                                                                            <span class="title">
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <br />
                                                                                <b class="secondary-text">Teléfono:</b>
                                                                                {{ $infocenter->user->present()->userTelefono() }}
                                                                                <br />
                                                                                <b class="secondary-text">Celular: </b>
                                                                            ...
                                                                            @can('show', $infocenter->user)
                                                                                <a target="_blank"
                                                                                    href="{{ route('usuario.show', $infocenter->user->documento) }}"
                                                                                    class="info">
                                                                                    Ver mas información del usuario.
                                                                                </a>
                                                                            @endcan
                                                    ...
                                                    <div class="row">
                                                        <div class="center">
                                                            <span class="secondary-text"><b>Expertos</b></span>
                                                        </div>
                                                        <div class="divider mailbox-divider"></div>
                                                        @forelse($nodo->expertos as $experto)
                                                            @if (isset($experto->user) &&
                                                                    $experto->user->hasRole(App\User::IsExperto()) &&
                                                                    $experto->user->estado == App\User::IsActive() &&
                                                                    $experto->user->deleted_at == null)
                                                                <div class="col s12 m12 l6">
                                                                    <ul class="collection">
                                                                        <li class="collection-item">
                                                                            <span class="title">
                                                                            ...
                                                                            <p>
                                                                                <b class="secondary-text">Número
                                                                                    documento:</b>
                                                                                {{ $experto->user->present()->userDocumento() }}
                                                                                <br />
                                                                                <b class="secondary-text">Correo
                                                                                    Electrónco:</b>
                                                                                {{ $experto->user->present()->userEmail() }}
                                                                                <br />
                                                                                <b class="secondary-text">Teléfono:</b>
                                                                                {{ $experto->user->present()->userTelefono() }}
                                                                                <br />
                                                                                <b class="secondary-text">Celular: </b>
                                                                            ...
                                                                            @can('show', $experto->user)
                                                                                <a target="_blank"
                                                                                    href="{{ route('usuario.show', $experto->user->documento) }}"
                                                                                    class="info">
                                                                                    Ver mas información del usuario.
                                                                                </a>
                                                                            @endcan
                                                    ...
                                                    <div class="row">
                                                        <div class="center">
                                                            <span class="secondary-text"><b>Articuladores</b></span>
                                                        </div>
                                                        <div class="divider mailbox-divider">
                                                        </div>
                                                        @forelse($nodo->articuladores as $articulador)
                                                            @if (isset($articulador->user) &&
                                                                    $articulador->user->hasRole(App\User::IsArticulador()) &&
                                                                    $articulador->user->estado == App\User::IsActive() &&
                                                                    $articulador->user->deleted_at == null)
                                                                <div class="col s12 m12 l6">
                                                                    <ul class="collection">
                                                                        <li class="collection-item">
                                                                            <span class="title">
                                                                            ...
                                                                            <p>
                                                                                <b class="secondary-text">Número
                                                                                    documento:</b>
                                                                                {{ $articulador->user->present()->userDocumento() }}
                                                                                <br />
                                                                                <b class="secondary-text">Correo
                                                                                    Electrónco:</b>
                                                                                {{ $articulador->user->present()->userEmail() }}
                                                                                <br />
                                                                                <b class="secondary-text">Teléfono:</b>
                                                                                {{ $articulador->user->present()->userTelefono() }}
                                                                                <br />
                                                                                <b class="secondary-text">Celular: </b>
                                                                            ...
                                                                            @can('show', $articulador->user)
                                                                                <a target="_blank"
                                                                                    href="{{ route('usuario.show', $articulador->user->documento) }}"
                                                                                    class="info">
                                                                                    Ver mas información del usuario.
                                                                                </a>
                                                                            @endcan
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @forelse($nodo->apoyostecnicos as $apoyotecnico)
                                                            @if (isset($apoyotecnico->user) &&
                                                                    $apoyotecnico->user->hasRole(App\User::IsApoyoTecnico()) &&
                                                                    $apoyotecnico->user->estado == App\User::IsActive() &&
                                                                    $apoyotecnico->user->deleted_at == null)
                                                                <div class="col s12 m12 l6">
                                                                    <ul class="collection">
                                                                        <li class="collection-item">
                                                                            <span class="title">
                                                                            ...
                                                                            <p>
                                                                                <b class="secondary-text">Número
                                                                                    documento:</b>
                                                                                {{ $apoyotecnico->user->present()->userDocumento() }}
                                                                                <br />
                                                                                <b class="secondary-text">Correo
                                                                                    Electrónco:</b>
                                                                                {{ $apoyotecnico->user->present()->userEmail() }}
                                                                                <br />
                                                                                <b class="secondary-text">Teléfono:</b>
                                                                                {{ $apoyotecnico->user->present()->userTelefono() }}
                                                                                <br />
                                                                                <b class="secondary-text">Celular: </b>
                                                                            ...
                                                                            @can('show', $apoyotecnico->user)
                                                                                <a target="_blank"
                                                                                    href="{{ route('usuario.show', $apoyotecnico->user->documento) }}"
                                                                                    class="info">
                                                                                    Ver mas información del usuario.
                                                                                </a>
                                                                            @endcan
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @forelse($nodo->ingresos as $ingreso)
                                                            @if (isset($ingreso->user) &&
                                                                    $ingreso->user->hasRole(App\User::IsIngreso()) &&
                                                                    $ingreso->user->estado == App\User::IsActive() &&
                                                                    $ingreso->user->deleted_at == null)
                                                                <div class="col s12 m12 l6">
                                                                    <ul class="collection">
                                                                        <li class="collection-item">
                                                                            <span class="title">
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <br />
                                                                                <b class="secondary-text">Teléfono:</b>
                                                                                {{ $ingreso->user->present()->userTelefono() }}
                                                                                <br />
                                                                                <b class="secondary-text">Celular: </b>
                                                                            ...
                                                                            @can('show', $ingreso->user)
                                                                                <a target="_blank"
                                                                                    href="{{ route('usuario.show', $ingreso->user->documento) }}"
                                                                                    class="info">
                                                                                    Ver mas información del usuario.
                                                                                </a>
                                                                            @endcan
