                                ...
                                <div class="col s12 m12 l12">
                                    <div class="mailbox-view">
                                        <div class="search-users">
                                            <div class="container">
                                                <br><br>
                                                <h2 class="header center hand-of-Sean-fonts orange-text text-darken-3">Empresas</h2>
                                                    ...
                                                    <form id="formSearchEmpresas" action="{{ route('empresa.search.rq') }}" method="POST">
                                                        ...
                                                        <div class="row">
                                                            <div class="input-field col s6  center-align offset-s3">
                                                                <button  type="submit" class="waves-effect waves-light btn-large"><i class="material-icons right">search</i>Buscar Empresa</button>
                                                            </div>
                                                        </div>
                                                    </form>
