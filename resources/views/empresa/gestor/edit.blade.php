              ...
              <div class="col s12 m12 l12">
                ...
                <form action="{{ route('empresa.update', $empresa->id)}}" method="POST" onsubmit="return checkSubmit()">
                  ...
                  <div class="row">
                    ...
                    <div class="input-field col s12 m6 l6">
                      <input type="text" name="codigo_ciiu" id="codigo_ciiu" value="{{ old('codigo_ciiu', $empresa->codigo_ciiu) }}">
                  ...
                  <div class="row">
                    ...
                    <div class="input-field col s12 m4 l4">
                      <input type="text" name="fecha_creacion" id="fecha_creacion" value="{{ old('fecha_creacion', $empresa->fecha_creacion) }}" class="datepicker picker__input">
                  ...
                  <div class="row">
                    <div class="input-field col s12 m6 l6">
                      <select class="js-states browser-default select2" id="txtdepartamento" name="txtdepartamento" onchange="EmpresaCreate.getCiudad()" style="width: 100%" tabindex="-1">
                        ...
                        <option value="{{$value->id}}" {{ $empresa->entidad->ciudad->departamento->id == $value->id ? 'selected' : '' }} {{ old('txtdepartamento') == $value->id ? 'selected' : '' }}>{{$value->nombre}}
                        </option>
                        @endforeach
                      </select>
