                                                                    ...
                                                                    <div class="card-content">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="input-field col s12 m6 l6 activator-field">
                                                                                <input id="activator_code_contract" name="activator_code_contract" type="text" value="{{ isset($user->activadorContratoLatest) && collect($user->activadorContratoLatest)->isNotEmpty() && collect($user->roles)->contains('name', App\User::IsActivador()) ? $user->activadorContratoLatest->codigo : old('activator_code_contract') }}">
