                                ...
                                <div class="col s12 m12 l12">
                                    ...
                                    <div class="mailbox-view">
                                        ...
                                        <div class="mailbox-text">
                                            <form action="{{ route('perfil.update', $user->id) }}" id="formEditProfile"
                                                        ...
                                                        <blockquote>
                                                            <ul class="collection">
                                                                <li class="collection-item">
                                                                    <span class="title"><b>Configuración
                                                                            principal</b></span>
                                                            ...
                                                            <div class="col m6">
                                                                <div class="row">
                                                                    <div class="input-field col m6 s12">
                                                                        <select name="txttipo_documento" style="width: 100%"
                                                                            tabindex="-1">
                                                                            ...
                                                                            @foreach ($tiposdocumentos as $value)
                                                                                @if (isset($user->tipoDocumento->id))
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txttipo_documento', $user->tipoDocumento->id) == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @else
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txttipo_documento') == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @endif
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="input-field col m6 s12">
                                                                        <input id="txtdocumento" name="txtdocumento"
                                                                            type="text" value="{{ $user->documento }}">
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <select class="js-states browser-default select2 "
                                                                            ...
                                                                            @foreach ($departamentos as $value)
                                                                                @if (isset($user->ciudadexpedicion->departamento_id))
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txtdepartamentoexpedicion', $user->ciudadexpedicion->departamento_id) == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @else
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txtdepartamentoexpedicion') == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @endif
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <div class="input-field col m6 s12">
                                                                        <select class="js-states browser-default select2"
                                                                            ...
                                                                            name="txtciudadexpedicion" style="width: 100%"
                                                                            tabindex="-1">
                                                                        ...
                                                                        <label class="active"
                                                                            for="txtciudadexpedicion">Ciudad
                                                                            de Expedición <span
                                                                                class="red-text">*</span></label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <select class="js-states browser-default select2"
                                                                            ...
                                                                            @foreach ($departamentos as $value)
                                                                                @if (isset($user->ciudad->departamento_id))
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txtdepartamento', $user->ciudad->departamento_id) == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @else
                                                                                    <option value="{{ $value->id }}"
                                                                        ...
                                                                        <label class="active"
                                                                            for="txtdepartamento">Departamento
                                                                            de Residencia <span
                                                                                class="red-text">*</span></label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col m6 s12">
                                                                        ...
                                                                        <label for="txtgrado_discapacidad">Algún grado de
                                                                            discapacidad <span
                                                                                class="red-text">*</span></label>
                                                                    ...
                                                                    <div class="input-field col s12 m6 l6 gradodiscapacidad"
                                                                        ...
                                                                        <label for="txtdiscapacidad"
                                                                            class="active">¿Cúal?<span
                                                                                class="red-text">*</span></label>
                                                                        <small
                                                                            id="txtdiscapacidad-error"class="error red-text"></small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col m6">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <select class="" id="txtgruposanguineo"
                                                                            name="txtgruposanguineo" style="width: 100%"
                                                                            tabindex="-1">
                                                                            ...
                                                                            @foreach ($gruposanguineos as $value)
                                                                                @if (isset($user->grupoSanguineo->id))
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txtgruposanguineo', $user->grupoSanguineo->id) == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @else
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txtgruposanguineo') == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @endif
                                                                            @endforeach
                                                                        </select>
                                                                        ...
                                                                        <select class="js-states browser-default select2"
                                                                            ...
                                                                            @foreach ($eps as $value)
                                                                                @if (isset($user->eps_id))
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txteps', $user->eps_id) == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @else
                                                                                    <option value="{{ $value->id }}"
                                                                                        {{ old('txteps') == $value->id ? 'selected' : '' }}>
                                                                                        {{ $value->nombre }}</option>
                                                                                @endif
                                                                            @endforeach
                                                                        </select>
                                                                ...
                                                                <div class="row">
                                                                    <div class="input-field col s12 m6 l6">
                                                                        <select class="" id="txtestrato"
                                                                            ...
                                                                            tabindex="-1">
                                                                            <option value="">Seleccione estrato
                                                                            </option>
                                                                            @for ($i = 1; $i <= 6; $i++)
                                                                                @if (isset($user->estrato))
                                                                                    <option value="{{ $i }}"
                                                                                        {{ old('txtestrato', $user->estrato) == $i ? 'selected' : '' }}>
                                                                                        {{ $i }}</option>
                                                                                @else
                                                                                    <option value="{{ $i }}"
                                                                                        {{ old('txtestrato') == $i ? 'selected' : '' }}>
                                                                                        {{ $i }}</option>
                                                                                @endif
                                                                            @endfor
                                                                        </select>
                                                                    ...
                                                                    <div class="input-field col s12 m6 l6">
                                                                        ...
                                                                        <select class="" id="txtetnias"
                                                                            name="txtetnias" style="width: 100%"
                                                                            tabindex="-1">
                                                                            <option value="">Seleccione Etnia
                                                                            </option>
                                                                            @foreach ($etnias as $id => $nombre)
                                                                                @if (isset($user->etnia->id))
                                                                                    <option value="{{ $id }}"
                                                                                        {{ old('txtetnias', $user->etnia->id) == $id ? 'selected' : '' }}>
                                                                                        {{ $nombre }}</option>
                                                                                @else
                                                                                    <option value="{{ $id }}"
                                                                                        {{ old('txtetnias') == $id ? 'selected' : '' }}>
                                                                                        {{ $nombre }}</option>
                                                                                @endif
                                                                            @endforeach
                                                                        </select>
                                                        ...
                                                        <blockquote>
                                                            <ul class="collection">
                                                                <li class="collection-item">
                                                                    ...
                                                                    <p>No puedes modificar el genero para hacerlo acuda
                                                                        a las instalaciones del nodo más cercano.</p>
                                                                ...
                                                                <div class="switch m-b-md">
                                                                    ...
                                                                    <p class="no-p-v">
                                                                        <input class="with-gap " name="txtgenero"
                                                                            type="radio" id="masculino" value="1"
                                                                            {{ isset($user->genero) && $user->genero == 1 ? 'checked' : old('txtgenero') }}>
                                                                        <label for="masculino"
                                                                            class="p-h-md">Masculino</label>
                                                                        <input class="with-gap" t name="txtgenero"
                                                                            type="radio" id="femenino" value="0"
                                                                            {{ isset($user->genero) && $user->genero == 0 ? 'checked' : old('txtgenero') }}>
                                                                        <label for="femenino"
                                                                            class="p-h-md">Femenino</label>
                                                                        <input class="with-gap" name="txtgenero"
                                                                            type="radio" id="no_binario" value="2"
                                                                            {{ isset($user->genero) && $user->genero == 2 ? 'checked' : old('txtgenero') }}>
                                                    ...
                                                    <div class="col s12 m9 l9"><br>
                                                        <div class="mailbox-view-header">
                                                            <div class="center">
                                                                <div class="center">
                                                                    <i
                                                                        class="Small material-icons prefix green-complement-text">
                                                                        supervised_user_circle
                                                                    </i>
                                                                </div>
                                                                <div class="center">
                                                                    <span
                                                                        class="mailbox-title green-complement-text">Último
                                                                        estudio</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="input-field col s12 m6 l6">
                                                                ...
                                                                <input class="validate datepicker"
                                                                    id="txtfechaterminacion" name="txtfechaterminacion"
                                                                    type="text"
                                                                    value="{{ isset($user->fecha_terminacion) ? $user->fecha_terminacion : old('txtfechaterminacion') }}">
        ...
        const user = {
            getCiudadExpedicion: function() {
                ...
                $.ajax({
                    ...
                    $.each(response.ciudades, function(i, e) {
                        $('#txtciudadexpedicion').append('<option  value="' + e.id + '">' + e
                            .nombre + '</option>');
                        @if (isset($user->ciudadexpedicion->id))
                            $('#txtciudadexpedicion').select2('val',
                                '{{ $user->ciudadexpedicion->id }}');
                        @endif
                    });
            ...
            getCiudad: function() {
                ...
                $.ajax({
                    ...
                    $.each(response.ciudades, function(i, e) {
                        $('#txtciudad').append('<option  value="' + e.id + '">' + e.nombre +
                            '</option>');
