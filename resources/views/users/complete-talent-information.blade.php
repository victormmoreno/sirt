        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="d-inline" method="POST" action="{{ route('informationtalent.complete') }}">
                        @csrf
...
@section('content')
    ...
    <div id="complete_talent_information" class="modal modal-fixed-footer">
        <form id="complete_talent_information_form" class="d-inline" method="POST" action="{{ route('informationtalent.complete') }}">
            @csrf
            {!! method_field('PUT')!!}
