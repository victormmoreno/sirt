                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6 l4 offset-m3 right">
                                <button class="waves-effect waves-grey btn-flat search-tabs-button right" id="download_equipos"><i class="material-icons left">cloud_download</i>Descargar</button>
                                <button class="waves-effect waves-grey btn-flat search-tabs-button right" id="filter_equipo"><i class="material-icons left">search</i>Buscar</button>
                            </div>
                        </div>
                        <br>
