          ...
          <div class="card-content">
            <div class="row">
              <div class="col s12 m12 l12">
                <br>
                <div class="center">
                  <span class="card-title center-align primary-text">Nuevo taller de fortalecimiento</span>
                </div>
                ...
                <form action="{{route('taller.store')}}" method="post" id="formEntrenamientosCreate">
                  ...
                  <div class="divider"></div>
                  <div class="center">
                    <button type="submit" class="bg-secondary btn center-aling"><i class="material-icons right">send</i>Guardar</button>
