                  ...
                  <div class="row">
                    <div class="col s12 m12 l10">
                      <div class="center-align">
                        <span class="card-title center-align"> Ingresos de Tecnoparque nodo {{ \NodoHelper::returnNameNodoUsuario() }} - {{ Carbon\Carbon::now()->isoFormat('YYYY') }}</span>
                      </div>
                    </div>
...
@push('script')
<script>
  consultarIngresosDeUnNodo({{auth()->user()->ingreso->nodo_id}});
</script>
@endpush
