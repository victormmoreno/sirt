...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        <input name="txtnombre" value="{{ $entrenamiento->fecha_sesion1 }}" disabled
...
<div class="row">
    <div class="col s4 m4 l4">
      <p class="p-v-xs">
          ...
          <input type="checkbox" name="txtcorreos" id="txtcorreos" value="1">
          @else
          <input type="checkbox" name="txtcorreos" checked id="txtcorreos" value="1">
          @endif
    ...
    <div class="col s4 m4 l4">
      <p class="p-v-xs">
          ...
          <input type="checkbox" name="txtfotos" id="txtfotos" value="1">
          @else
          <input type="checkbox" name="txtfotos" checked id="txtfotos" value="1">
          @endif
    ...
    <div class="col s4 m4 l4">
      <p class="p-v-xs">
          ...
          <input type="checkbox" name="txtlistado_asistencia" id="txtlistado_asistencia" value="1">
          @else
          <input type="checkbox" name="txtlistado_asistencia" checked id="txtlistado_asistencia" value="1">
          @endif
  ...
  <div class="row">
    <div class="center col s12 m12 l12">
      <h6>Pulse aquí para subir los entregables del taller de fortalecimiento.</h6>
