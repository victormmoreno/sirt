...
<div class="row">
  <div class="input-field col s12 m6 l6">
    <input type="text" id="txtfecha_inicio" href="javascript:void(0)" name="txtfecha_inicio"/>
  ...
  <div class="input-field col s12 m6 l6">
    <input type="text" id="txtfecha_fin" href="javascript:void(0)" name="txtfecha_fin"/>
