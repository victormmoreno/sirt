                    ...
                    <div class="card-content">
                        <div class="row">
                                ...
                                <div class="primary-text">
                                    <div class="mailbox-view-header">
                                        <div class="center-align">
                                            <h1 class="card-title center-align text-2xl no-m">Migración de caracterización de proyectos</h1>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col s12 m12 l12">
                                    <form action="{{route('migracion.proyectos.caracterizacion.store')}}" method="POST" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        <div class="row">
                                            <div class="col s12 m12 l12">
