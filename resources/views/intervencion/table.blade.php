<table id="intervencionesNodo_table" class="display responsive-table datatable-example dataTable" style="width: 100%">
    ...
    <tfoot>
        <tr>
            <th><input type="text" name="email" class="codigo_articulacion"
                    placeholder="Buscar por código de articulación"></th>
            <th><input type="text" name="nombre" class="nombre" placeholder="Buscar por nombre"></th>
            <th><input type="text" name="nombre_completo_gestor" class="nombre_completo_gestor"
                    placeholder="Buscar por experto"></th>
