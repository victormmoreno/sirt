                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="center-align">
                                        <span class="card-title">Intervención a Empresas - Tecnoparque nodo
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <ul class="tabs" style="width: 100%;">
                                        <li class="tab col s3"><a href="#articulaciones_por_nodo"
                                                class="active">Intervención a Empresas del Nodo</a></li>
                                        <li class="tab col s3"><a href="#articulaciones_por_gestor">Intervención a Empresas
                                                por experto</a></li>
                            ...
                            <div id="articulaciones_por_gestor">
                                <div class="col s12 m6 l6">
                                    <div class="input-field">
                                        <select class="js-states" tabindex="-1" style="width: 100%"
                                            id="txtanho_articulaciones_Gestor" name="txtanho_articulaciones_Gestor"
                                            onchange="consultarIntervencionNodo(this.value);">
                                            @for ($i = 2016; $i <= $year; $i++)
                                                <option value="{{ $i }}"
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <select class="initialized" id="txtgestor_id" name="txtgestor_id" style="width: 100%"
                                        tabindex="-1">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="input-field col s12 m12 l12">
                                            <select class="js-states" tabindex="-1" style="width: 100%"
                                                id="txtanho_articulaciones_Nodo" name="txtanho_articulaciones_Nodo"
                                                onchange="consultarIntervencionNodo(this.value);">
                                                @for ($i = 2016; $i <= $year; $i++)
                                                    <option value="{{ $i }}"
                                                        {{ $i == Carbon\Carbon::now()->isoFormat('YYYY') ? 'selected' : '' }}>
