          ...
          <div class="row">
              <div class="col s8 m8 l9">
                  <h5>
                    ...
                    </a> Intervenciones a  Empresas
                  </h5>
              </div>
              <div class="col s4 m4 l3 rigth-align show-on-large hide-on-med-and-down">
                  <ol class="breadcrumbs">
                      <li><a href="{{route('home')}}">Inicio</a></li>
                      <li><a href="{{route('articulacion')}}">Intervenciones a  Empresas</a></li>
            ...
            <div class="card-content">
              <div class="row">
                <div class="col s12 m12 l12">
                  <br>
                  <center>
                    <span class="card-title center-align">Modificar Intervención - <b>{{ $articulacion->articulacion_proyecto->actividad->codigo_actividad }}</b></span>
                  </center>
                  ...
                  <form method="POST" action="{{route('intervencion.update', $articulacion->id)}}" onsubmit="return checkSubmit()">
                    {!! csrf_field() !!}
                    {!! method_field('PUT')!!}
