            ...
            <div class="row no-m-t no-m-b">
                <div class="row">
                    <div class="col s8 m8 l9">
                        <h5>
                            <a class="footer-text left-align" href="{{ route('intervencion.index') }}" rel="nofollow">
                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <form onsubmit="return checkSubmit()" method="post"
                                    action="{{ route('intervencion.update.entregables', $articulacion->id) }}">
                                    @include('intervencion.form_entregables')
                                    <center>
                                        <button type="submit" class="waves-effect cyan darken-1 btn center-aling"><i
                                                class="material-icons right">done</i>Modificar</button>
                                        <a href="{{ route('intervencion.index') }}"
                                            class="waves-effect red lighten-2 btn center-aling"><i
                                        ...
                                        <ul class="collapsible" data-collapsible="accordion">
                                            <li>
                                                <div class="collapsible-header teal lighten-4"><i
                                                        class="material-icons">filter_drama</i>Pulse aquí para ver los
                                                    entregables de la articulación</div>
                                                <div class="collapsible-body">
                                                    <div class="row">
                                                        <div class="col s12 m12 l12">
                                                            <table
                                                                class="display responsive-table datatable-example dataTable"
                                                                style="width: 100%" id="archivoDeUnaArticulacion">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Archivo</th>
                                                                        <th>Fase</th>
    ...
    <div id="modalContenidoActaInicio" class="modal">
        <div class="modal-content">
            ...
            <ul class="collection">
                ...
                <li class="collection-item">Pantallazo del GrupLac de Colciencias donde se evidencie la institución que
                    avala el grupo y la categoría a la fecha.</li>
                <li class="collection-item">Para grupos de investigación SENA: Incluir el código de registro en SGPS de los
                    proyectos con recursos aprobados.</li>
            </ul>
        </div>
