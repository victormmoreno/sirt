        ...
        <div class="row">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    ...
                    <input id="txtnombres" name="txtnombres" type="text" value="{{auth()->user()->nombres}}" disabled>
                ...
                <div class="input-field col s12 m6 l6">
                    ...
                    <input id="txtapellidos" name="txtapellidos" type="text" disabled value="{{auth()->user()->apellidos}}">
            ...
            <div class="row">
                <div class="input-field col s12 m6 l6">
                    ...
                    <input id="txtcorreo" name="txtcorreo" type="text" disabled value="{{auth()->user()->email}}"/>
                ...
                <div class="input-field col s12 m6 l6">
                    ...
                    <input id="txttelefono" name="txttelefono" disabled value="{{auth()->user()->telefono == null ? auth()->user()->celular : auth()->user()->telefono}}"/>
                    <label for="txttelefono" class="active">Teléfono / Celular</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12 m12 l12 offset-l6 offset-m6 offset-s6  pull-l1 pull-m1 pull-s1">
                    <div class="switch m-b-md">
                        ...
                        <label>
                            No
                            <input disabled id="txtaprendiz_sena" name="txtaprendiz_sena" type="checkbox" {{ auth()->user()->talento->tipotalento->nombre == 'Aprendiz SENA con apoyo de sostenimiento' || auth()->user()->talento->tipotalento->nombre == 'Aprendiz SENA sin apoyo de sostenimiento' ? 'checked' : ''}}>
    ...
    <div class="card-content">
        ...
        <div class="row">
            <div class="input-field col s12 m6 l6">
                ...
                <small id="txtalcance-error" class="error red-text"></small>
            </div>
            <div class="input-field col s12 m6 l6">
                ...
                <div class="input-field col s12 m9 l9">
                    ...
                    <small id="txtnombreconvocatoria-error" class="error red-text"></small>
                </div>
        ...
        <div class="row">
            <div class="input-field col s12 m12 l12">
                <div class="input-field col s12 m3 l3">
                    ...
                    <small id="txtavalempresa-error" class="error red-text"></small>
                </div>
                <div class="input-field col s12 m9 l9">
                ...
                <label for="txtempresa" class="active">
                    ¿La idea viene avalada por una empresa?
                </label>
            </div>
        </div>
        <div class="row">
    ...
    <div class="card-content">
        <div class="row section">
            <div class="col s10 m10 l10">
                <h4 class="card-title center-align">Datos de la empresa</h4>
            </div>
            <div class="col s2 m2 l2">
                <a href="#infoEmpresaIdea" class="btn-floating btn-large waves-effect tooltipped waves-light blue modal-trigger left" data-position="bottom" data-delay="50" data-tooltip="Ayuda"><i class="material-icons">help_outline</i></a>
            </div>
        </div>
        ...
        <div class="row center">
            <div class="input-field">
                <div class="switch m-b-md">
                    <label class="active">
                        ¿La propiedad intelectual de la idea de proyecto es de una empresa?
                    </label>
                    <label>
                        No
                        <input id="bandera_empresa" name="bandera_empresa" type="checkbox" value="1" onchange="banderaEmpresaIdea()">
                        <span class="lever"></span>
                        Si
                    </label>
                </div>
        ...
        <br>
        <div class="row" id="divIngresarEmpresaIdea">
            <div class="input-field col s11 m11 l11">
              <input name="txtnit"  id="txtnit" type="text" value="{{ isset($idea) ? $idea->empresa->nit : '' }}">
              <label for="txtnit">Nit de la empresa (Sin puntos ni dígito de verificación)</label>
              <small id="txtnit-error" class="error red-text"></small>
            </div>
            <div class="col s1 m1 l1">
              <a class="btn-floating btn-large waves-effect tooltipped waves-light blue" data-position="bottom" data-delay="50" data-tooltip="Verificar" id="btnNitEmpresa" onclick="consultarEmpresaTecnoparque()"><i class="material-icons">search</i></a>
            </div>
        </div>
    </div>
</div>
<div id="divRegistrarEmpresa" class="card-panel orange lighten-5">
    <h4 class="center">Registrar nueva empresa</h4>
    <div class="divider"></div>
    <br />
...
<div class="card">
    <div class="card-content">
        ...
        <div class="row section">
            <div class="input-field col s12 m12 l12">
                <h5 class="center">¿En qué estado se encuentra su propuesta?</h5>
            </div>
        </div>
        <div class="row section">
            <div class="input-field col s12 m6 l6">
        ...
        <div class="row section">
            <div class="input-field col s12 m12 l12">
                <h5 class="center">Marque en cuál de las siguientes categorías clasificaría su propuesta</h5>
            </div>
        </div>
        <div class="row section">
            <div class="input-field col s12 m6 l6">
...
<div id="infoEmpresaIdea" class="modal">
    <div class="modal-content">
      <h4>¿Cuando se debe digitar el NIT de la empresa?</h4>
      <p>
          En caso de que la idea de proyecto que se va a registrar es de la empresa donde laboras, se debe asociar a la empresa.
          <br>
          Si la idea que se va a desarrollar es de tu propiedad intelectual, en este caso no hay que llenar la información de ninguna empresa.
      </p>
    </div>
