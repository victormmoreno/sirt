    ...
    <div class="content">
        ...
        <div class="row no-m-t no-m-b">
            <div class="col s12 m12 l12">
                <div class="card">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                <div class="row">
                                    @can('listNodes', \App\Models\ArticulacionPbt::class)
                                    ...
                                    @endcan
                                    @can('create', \App\Models\ArticulacionPbt::class)
                                        <div class="col s12 m4 l4 ">
                                ...
                                <div class="row search-tabs-row search-tabs-header">
                                    ...
                                    <div class="col s12 m6 l4 offset-m3 right">
                                        @can('downloadAll', \App\Models\ArticulacionPbt::class)
                ...
                @can('index', \App\Models\TipoArticulacion::class)
                    <div class="fixed-action-btn show-on-medium-and-down hide-on-med-and-up">
                        <a href="{{route('tipoarticulaciones.index')}}"  class="btn tooltipped btn-floating btn-large grey" data-position="left" data-delay="50" data-tooltip="Tipos de articulación">
                            <i class="material-icons">add</i>
                        </a>
                    </div>
                @endcan
