                            ...
                            <div class="col s12 m12 l12">
                                ...
                                <div class="mailbox-view no-s">
                                    <div class="mailbox-view-header">
                                        <div class="left">
                                            <span class="mailbox-title">{{$articulacion->present()->articulacionCode()}} - {{$articulacion->present()->articulacionName()}}</span>
                                            <div class="left">
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 m12 l12">
                                                            <form action="{{route('articulacion.update.entregables.inicio', $articulacion->id)}}" method="POST" onsubmit="return checkSubmit()">
                                                                ...
                                                                @endif
                                                                <a href="{{ route('articulacion.show.inicio', $articulacion->id) }}" class="waves-effect red lighten-2 btn center-aling"><i class="material-icons right">backspace</i>Cancelar</a>
                                                                </center>
                                                            </form>
                                                        </div>
                                                    </div>
