...
<div class="row">
    ...
    <div class="col s6 m6 l6">
        <p class="p-v-xs">
            <input type="checkbox" {{$articulacion->present()->articulacionPbtNameFase()  != 'Inicio' ? 'disabled' : '' }} {{ $articulacion->formulario_inicio == 1 ? 'checked' : '' }} id="txtformulario_inicio" name="txtformulario_inicio" value="1">
