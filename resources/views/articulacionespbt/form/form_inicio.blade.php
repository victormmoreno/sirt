<ul class="collapsible collapsible-art" data-collapsible="expandable">
    <li class="collapsible-li active" >
        <div class="collapsible-header grey lighten-2 active"><i class="material-icons">library_books</i>Información básica</div>
        <div class="collapsible-body active" style="">
            <div class="row search-tabs-row search-tabs-header">
                <div class="card card-transparent">
                    <div class="card-content">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l6">
                                ...
                                <select  @if(isset($articulacion) && !$articulacion->present()->articulacionPbtIssetFase(App\Models\Fase::IsInicio())) disabled @endif  name="txt_tipo_articulacion" id="txt_tipo_articulacion">
                                    <option value disabled selected>Seleccione tipo Articulación</option>
                            ...
                            <div class="input-field col s12 m12 l6">
                                ...
                                <select @if( isset($articulacion) && !$articulacion->present()->articulacionPbtIssetFase(App\Models\Fase::IsInicio())) disabled @endif  id="txt_alcance_articulacion" name="txt_alcance_articulacion" style="width: 100%" tabindex="-1">
                                    <option value disabled selected>Seleccione Alcance Articulación</option>
                        ...
                        <blockquote id="description-type-art">
                        </blockquote>
                        <div class="row">
                            <div class="input-field col s12 m12 l6">
                                @if(isset($articulacion))
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l6">
                                ...
                                @endif
                                <label for="txtnombre_convocatoria">Nombre de tipo de articulacion (Opcional)</label>
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12">
                                ...
                                @endif
                                <label for="txtobjetivo">Objetivo de la articulación<span class="red-text">*</span></label>
    ...
    <li class="collapsible-li section-projects">
        <div class="collapsible-header grey lighten-2 "><i class="material-icons">subtitles</i>Seleccione PBT</div>
