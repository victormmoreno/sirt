    ...
    <div class="input-field col s12 m12 l12">
        <p class="center p-v-xs">
            @if(isset($articulacion))
                ...
                <input class="with-gap" id="IsPbt" name="txttipovinculacion" type="radio" @if($articulacion->present()->articulacionPbtTipoVinculacion(App\Models\ArticulacionPbt::IsPbt())) checked @endif value="1" onchange="checkTipoVinculacion(this)"/>
                <label for="IsPbt">
                    PBT
                </label>
                <input class="with-gap" id="IsSenaInnova" name="txttipovinculacion" type="radio" @if($articulacion->present()->articulacionPbtTipoVinculacion(App\Models\ArticulacionPbt::IsSenaInnova())) checked @endif  value="2" onchange="checkTipoVinculacion(this)"/>
                <label for="IsSenaInnova">
                    Sena Innova
                </label>
                <input class="with-gap" id="IsColinnova" name="txttipovinculacion" type="radio" @if($articulacion->present()->articulacionPbtTipoVinculacion(App\Models\ArticulacionPbt::IsColinnova())) checked @endif  value="3" onchange="checkTipoVinculacion(this)"/>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card card-transparent p f-12">
                                ...
                                <div class="card-content">
                                    <span class="card-title p f-12">{{$articulacion->present()->articulacionPbtCodeProyecto()}} - {{$articulacion->present()->articulacionPbtNameProyecto()}}</span>
                                    ...
                                    <input type="hidden" name="txtpbt" value="{{$articulacion->present()->articulacionPbtIdProyecto()}}"/>
                                </div>
                ...
                <div class="card card-transparent">
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m12 l12">
                                @if(isset($articulacion))
                                    <input @if(!$articulacion->present()->articulacionPbtIssetFase(App\Models\Fase::IsInicio())) disabled @endif  id="txtnombre_articulacion" name="txtnombre_articulacion" type="text" class="validate" value="{{$articulacion->present()->articulacionPbtName()}}">
                                @else
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l6">
                                ...
                                <select  @if(isset($articulacion) && !$articulacion->present()->articulacionPbtIssetFase(App\Models\Fase::IsInicio())) disabled @endif  name="txt_tipo_articulacion" id="txt_tipo_articulacion">
                                    ...
                                    @if (isset($articulacion))
                                        <option value="{{$id}}" {{ old('txt_tipo_articulacion', $articulacion->tipoarticulacion->id) == $id ? 'selected':'' }}>{{$name}}</option>
                                    @else
                            ...
                            <div class="input-field col s12 m12 l6">
                                ...
                                <select @if( isset($articulacion) && !$articulacion->present()->articulacionPbtIssetFase(App\Models\Fase::IsInicio())) disabled @endif  id="txt_alcance_articulacion" name="txt_alcance_articulacion" style="width: 100%" tabindex="-1">
                                    ...
                                    @forelse($alcances  as $id => $name)
                                        @if (isset($articulacion))
                                            <option value="{{$id}}" {{ old('txt_alcance_articulacion', $articulacion->alcancearticulacion->id) == $id ? 'selected':'' }}>{{$name}}</option>
                                        @else
