                                    ...
                                    <div class="mailbox-view-header no-m-b no-m-t">
                                        ...
                                        @if ($actividad->articulacionpbt->present()->articulacionPbtIssetFase(App\Models\Fase::IsCierre()))
                                            ...
                                            <form action="{{route('articulacion.aprobacion', [$actividad->articulacionpbt->id, 'Cierre'])}}" method="POST" name="frmCierreTalento">
                                                ...
                                                <button type="submit" onclick="preguntaCierreRechazar(event)" class="waves-effect waves-grey btn grey m-t-xs">
...
function preguntaCierreRechazar(e){
    e.preventDefault();
    Swal.fire({
    title: '¿Está seguro(a) de no aprobar la fase de cierre de esta articulación?',
    input: 'text',
    type: 'warning',
