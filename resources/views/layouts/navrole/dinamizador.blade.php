...
<li class="no-padding">
    <a
        class="collapsible-header waves-effect waves-grey {{ setActiveRouteActivePage('idea') }} {{ setActiveRouteActivePage('taller') }} {{ setActiveRouteActivePage('csibt') }} {!! setActiveRoutePadding('idea'), setActiveRoutePadding('taller'), setActiveRoutePadding('csibt') !!}">
        <i
            class="material-icons {{ setActiveRouteActiveIcon('idea') }} {{ setActiveRouteActiveIcon('taller') }} {{ setActiveRouteActiveIcon('csibt') }}">lightbulb_outline</i>Ideas
        de Proyecto
        <i
            class="nav-drop-icon material-icons {{ setActiveRouteActiveIcon('idea') }} {{ setActiveRouteActiveIcon('taller') }} {{ setActiveRouteActiveIcon('csibt') }}">keyboard_arrow_right</i>
    </a>
    <div class="collapsible-body">
        <ul>
            ...
            <li class="no-padding">
                <a href="{{ route('csibt') }}" class="{{ setActiveRouteActivePage('csibt') }}" rel="canonical"
                    title="CSIBT's">
            ...
            <li>
                <a href="{{ route('taller') }}" class="{{ setActiveRouteActivePage('taller') }}" rel="canonical"
                    ...
                    <i class="material-icons {{ setActiveRouteActiveIcon('taller') }}">library_books</i>Taller de
                    fortalecimiento
                </a>
            </li>
        </ul>
...
<li class="{!! setActiveRoute('costos-administrativos') !!}">
    <a class="waves-effect waves-grey {!! setActiveRouteActivePage('costos-administrativos') !!}" href="{{ route('costoadministrativo.index') }}"
        rel="canonical" title="Costos Administrativos">
...
<li class="no-padding">
    ...
    <div class="collapsible-body">
        <ul>
            <li>
                <a href="{{ route('equipo.index') }}" class="{{ setActiveRouteActivePage('equipo') }}" rel="canonical"
                    title="Equipos">
...
<li class="no-padding {{ setActiveRoute('empresa') }}">
    <a class="{{ setActiveRouteActivePage('empresa') }}" href="{{ route('empresa') }}" rel="canonical"
        title="Empresas">
