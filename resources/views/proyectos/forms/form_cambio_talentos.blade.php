                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="row">
                                ...
                                <br />
                                <form action="{{ route('proyecto.update.talentos', $proyecto->id) }}" method="POST"
                                    id="frmUpdateTalentos" name="frmUpdateTalentos">
                                    {!! method_field('PUT') !!}
                                    @csrf
                                    @include('proyectos.detalles.componente_talentos_proyecto', [
                                        'proyecto' => $proyecto,
                                    ])
                                    ...
                                    <center>
                                        ...
                                        <a href="{{ route('proyecto.inicio', $proyecto->id) }}"
                                            class="waves-effect waves-light btn bg-danger center-align">
    ...
    <script>
        $(document).ready(function() {
            consultarTalentosDeTecnoparque_Proyecto_FaseInicio_table(
                '#talentosDeTecnoparque_Proyecto_FaseInicio_table', 'add_proyecto');
        })
    </script>
@endpush
