                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="center-align">
                                <span
                                    class="card-title center-align primary-text">Proyectos de Tecnoparque nodo {{ \NodoHelper::returnNameNodoUsuario() }} </span>
                            </div>
                            <div class="divider"></div>
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <ul class="tabs" style="width: 100%;">
                                        <li class="tab col s3"><a href="#proyectos_por_nodo" class="active">Proyectos
                                                del Nodo</a></li>
                                        <li class="tab col s3"><a class="" href="#proyectos_por_gestor">Proyectos por
                                                experto</a></li>
