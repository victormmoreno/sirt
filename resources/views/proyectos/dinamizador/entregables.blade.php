            ...
            <div class="col s12 m12 l12">
              <form action="{{route('proyecto.update.entregables', $proyecto->id)}}" method="POST" onsubmit="return checkSubmit()">
                ...
                <div class="row">
                  ...
                  <div class="col s12 m4 l4">
                    <p class="p-v-xs">
                      <input name="txtrevisado_final" {{ $proyecto->revisado_final == 'Por Evaluar' ? 'checked' : ''}} type="radio" id="txtrevisadoa" value="0">
                      <label for="txtrevisadoa">Por evaluar</label>
                    </p>
                  </div>
                  <div class="col s12 m4 l4">
                    <p class="p-v-xs">
                      <input name="txtrevisado_final" {{ $proyecto->revisado_final == 'Aprobado' ? 'checked' : '' }} type="radio" id="txtrevisadob" value="1">
                      <label for="txtrevisadob">Aprobado</label>
                    </p>
                  </div>
                  <div class="col s12 m4 l4">
                    <p class="p-v-xs">
                      <input name="txtrevisado_final" {{ $proyecto->revisado_final == 'No Aprobado' ? 'checked' : ''}} type="radio" id="txtrevisadoc" value="2">
