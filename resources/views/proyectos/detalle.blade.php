                                        ...
                                        @if ($proyecto->fase->nombre == 'Cierre' || $proyecto->fase->nombre == 'Suspendido')
                                            @if(Session::get('login_role') == App\User::IsAdministrador())
                                                <div class="col s12 m3 l3">
                                                    <form
                                                        action="{{route('proyecto.reversar', [$proyecto->id, 'Inicio'])}}"
                                                        method="POST" name="frmReversarFase">
                                                        {!! method_field('PUT')!!}
                                                        @csrf
                                                        <button type="submit" onclick="preguntaReversar(event)"
                                                                value="send" class="btn-flat">
                                                ...
                                                <div class="col s12 m3 l3">
                                                    <form
                                                        action="{{route('proyecto.reversar', [$proyecto->id, 'Planeación'])}}"
                                                        method="POST" name="frmReversarFasePlaneacion">
                                                        {!! method_field('PUT')!!}
                                                        @csrf
                                                        <button type="submit"
                                                                onclick="preguntaReversarPlaneacion(event)" value="send"
                                                                class="btn-flat">
                                                ...
                                                <div class="col s12 m3 l3">
                                                    <form
                                                        action="{{route('proyecto.reversar', [$proyecto->id, 'Ejecución'])}}"
                                                        method="POST" name="frmReversarFaseEjecucion">
                                                        {!! method_field('PUT')!!}
                                                        @csrf
                                                        <button type="submit" onclick="preguntaReversarEjecucion(event)"
                                                                value="send" class="btn-flat">
