...
<div class="row">
    <div class="col s12 m4 l4">
        <div class="card-panel green lighten-5">
            ...
            <div class="row center">
                <a class="btn btn-medium green"
                    onclick="consultarTalentosDeTecnoparque_Proyecto_FaseInicio_table('#posiblesPropietarios_Personas_table', 'add_propiedad');">Agregar</a>
            </div>
    ...
    <div class="col s12 m4 l4">
        <div class="card-panel blue lighten-5">
            ...
            <div class="row center">
                <a class="btn btn-medium blue"
                    onclick="consultarEmpresasDeTecnoparque_Proyecto_FaseInicio_table();">Agregar</a>
            </div>
    ...
    <div class="col s12 m4 l4">
        <div class="card-panel teal lighten-5">
            ...
            <div class="row center">
                <a class="btn btn-medium teal"
                    onclick="consultarGruposDeTecnoparque_Proyecto_FaseInicio_table();">Agregar</a>
            </div>
