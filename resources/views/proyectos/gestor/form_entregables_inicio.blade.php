...
<div class="row">
    ...
    <div class="col s6 m3 l3">
        <p class="p-v-xs">
            <input type="checkbox" {{$proyecto->present()->proyectoFase() != 'Inicio' ? 'disabled' : '' }} {{ $proyecto->acc == 1 ? 'checked' : '' }} id="txtacc" name="txtacc" value="1">
            <label for="txtacc">Formato de confidencialidad y compromiso firmado.</label>
        </p>
    </div>
    <div class="col s6 m3 l3">
        <p class="p-v-xs">
            <input type="checkbox" {{$proyecto->present()->proyectoFase() != 'Inicio' ? 'disabled' : '' }} {{ $proyecto->doc_titular == 1 ? 'checked' : '' }} id="txtdoc_titular" name="txtdoc_titular" value="1">
            <label for="txtdoc_titular">Documento del Titular.</label>
        </p>
    </div>
    <div class="col s6 m3 l3">
        <p class="p-v-xs">
            <input type="checkbox" {{$proyecto->present()->proyectoFase() != 'Inicio' ? 'disabled' : '' }} {{ $proyecto->manual_uso_inf == 1 ? 'checked' : '' }} id="txtmanual_uso_inf" name="txtmanual_uso_inf" value="1">
            <label for="txtmanual_uso_inf">Manual de uso de infraestructura.</label>
        </p>
    </div>
    <div class="col s6 m3 l3">
        <p class="p-v-xs">
            <input type="checkbox" {{$proyecto->present()->proyectoFase() != 'Inicio' ? 'disabled' : '' }} {{ $proyecto->articulacion_proyecto->actividad->formulario_inicio == 1 ? 'checked' : '' }} id="txtformulario_inicio" name="txtformulario_inicio" value="1">
