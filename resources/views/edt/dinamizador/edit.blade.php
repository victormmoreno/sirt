                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <br>
                                    <center>
                                        <span class="card-title center-align">Modificar Edt -
                                            <b>{{ $edt->codigo_edt }}</b></span>
                                    </center>
                                    ...
                                    <form method="POST" action="{{ route('edt.update', $edt->id) }}"
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <input disabled type="text" id="txtcodigo_actividad"
                                                    name="txtcodigo_actividad" value="{{ $edt->codigo_edt }}" />
                                                <label for="txtcodigo_actividad">Código de la Edt</label>
                                            </div>
                                            <div class="input-field col s12 m6 l6">
                                                <input disabled type="text" id="txtnombre" name="txtnombre"
                                                    value="{{ $edt->nombre }}" />
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select id="txtgestor_id" class="js-states" name="txtgestor_id"
                                                    ...
                                                    @forelse ($gestores as $id => $value)
                                                        <option value="{{ $id }}"
                                                            {{ $id == $edt->gestor_id ? 'selected' : '' }}
                                                            {{ old('txtgestor_id') == $id ? 'selected' : '' }}>
                                                            {{ $value }}</option>
                                                    @empty
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input disabled type="text" id="txtlineatecnologica_id"
                                                    name="txtlineatecnologica_id" value="{{ $edt->nombre_linea }}">
                                                <label for="txtlineatecnologica_id">Línea Tecnológica</label>
                                            </div>
                                        </div>
                                        <div class="divider"></div>
                                        <center>
                                            <button type="submit" class="cyan darken-1 btn center-aling"><i
