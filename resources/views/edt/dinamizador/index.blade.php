                ...
                <div class="col s12 m12 l12">
                    ...
                    <div class="card stats-card">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="center-align">
                                        <span class="card-title center-align"> Edts de Tecnoparque nodo
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="input-field col s12 m12 l12">
                                        <select class="js-states" tabindex="-1" style="width: 100%" id="txtanho_edts_Nodo"
                                            name="txtanho_edts_Nodo" onchange="datatableEdtsPorNodo(0);">
                                            @for ($i = 2016; $i <= $year; $i++)
                                                <option value="{{ $i }}"
                            ...
                            <table class="display responsive-table datatable-example" style="width: 100%"
                                id="edtPorNodo_table">
                                <thead>
