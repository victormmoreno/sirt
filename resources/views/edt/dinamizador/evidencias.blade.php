                        ...
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <form onsubmit="return checkSubmit()" method="post"
                                    action="{{ route('edt.update.evidencias', $edt->id) }}">
                                    {!! method_field('PUT') !!}
                                    {!! csrf_field() !!}
                                    @include('edt.gestor.form_entregables')
                                    <center>
                                        <a href="{{ route('edt') }}" class="waves-effect red lighten-2 btn center-aling"><i
