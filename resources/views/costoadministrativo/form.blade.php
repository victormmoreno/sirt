<div class="col s12 m8 l8 offset-l2 offset-m2">
    ...
    <div class="row">
        <div class="col s12 m12 l12">
            <blockquote>
                <ul class="collection">
                    <li class="collection-item">Debes tener en cuenta que el costo administrativo de
                        <b>{{ $costoadministrativo->costoadministrativo }}</b> soló será válido para el presente año.
                        <br /> Recuerde que este valor solo se ingresa una sola vez al año</li>
                </ul>
            </blockquote>
        </div>
    </div>
    <div class="row">
        <div class="input-field col s12 m6 l6 offset-l3 offset-m3">
            ...
            <input id="txtcostoadministrativo" type="text"
                value="{{ isset($costoadministrativo->costoadministrativo) ? $costoadministrativo->costoadministrativo : 'No Registra' }}"
                readonly>
    ...
    <div class="row">
        <div class="input-field col s12 m6 l6 offset-l3 offset-m3">
            ...
            <input id="txtvalor" name="txtvalor" type="text"
                value="{{ isset($costoadministrativo->valor) ? $costoadministrativo->valor : old('txtvalor') }}">
            <label for="txtvalor">
