                ...
                <div class="row">
                  <div class="col s12 {{auth()->user()->can('create', App\Models\GrupoInvestigacion::class) ? 'm8 l8' : 'm12 l12'}}">
                    <div class="center-align">
                      <span class="card-title center-align primary-text">Grupos de Investigación de Tecnoparque</span>
                    </div>
                  </div>
                  @can('create', App\Models\GrupoInvestigacion::class)
                    <div class="col s12 m4 l4 right">
                        <a  href="{{route('grupo.create')}}" class="btn bg-secondary right show-on-large hide-on-med-and-down">Nuevo grupo de investigación</a>
                    </div>
                  @endcan
                </div>
