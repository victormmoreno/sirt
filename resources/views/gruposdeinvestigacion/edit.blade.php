                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    ...
                                    <div class="center primary-text">
                                        <span class="card-title center-align">Cambiar información -
                                            {{ $grupo->codigo_grupo }}</span>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <input type="text" name="txtcodigo_grupo" id="txtcodigo_grupo"
                                                    value="{{ old('txtcodigo_grupo', $grupo->codigo_grupo) }}">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input type="text" name="txtnombre" id="txtnombre"
                                                    value="{{ old('txtnombre', $grupo->entidad->nombre) }}">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <input type="text" name="txtemail_entidad" id="txtemail_entidad"
                                                    value="{{ old('txtemail_entidad', $grupo->entidad->email_entidad) }}">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <select id="txtclasificacionclociencias_id"
                                                    ...
                                                    @foreach ($clasificaciones as $key => $value)
                                                        <option
                                                            value="{{ $value->id }}"{{ $grupo->clasificacioncolciencias->id == $value->id ? 'selected' : '' }}
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12 m6 l6">
                                                <select id="txttipogrupo" name="txttipogrupo">
                                                    ...
                                                    <option value="0"{{ $grupo->tipogrupo == 1 ? 'selected' : '' }}
                                                        {{ old('txttipogrupo') == '1' ? 'selected' : '' }}>Externo</option>
                                                    <option value="1"{{ $grupo->tipogrupo == 0 ? 'selected' : '' }}
                                                        {{ old('txttipogrupo') == '0' ? 'selected' : '' }}>SENA</option>
                                                </select>
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <input type="text" name="txtinstitucion" id="txtinstitucion"
                                                    value="{{ old('txtinstitucion', $grupo->institucion) }}">
                                            ...
                                            <div class="input-field col s12 m6 l6">
                                                <select class="" id="txtdepartamento" name="txtdepartamento"
                                                    ...
                                                    @foreach ($departamentos as $value)
                                                        <option
                                                            value="{{ $value->id }}"{{ $grupo->entidad->ciudad->departamento->id == $value->id ? 'selected' : '' }}
