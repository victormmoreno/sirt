        ...
        <ul class="collection with-header">
            ...
            <div id="nodos_data">
                @include('indicadores.componentes.nodo_pagination', [
                    'idPager' => 'PagerActual',
                    'idTable' => 'TableActual',
                    'checkName' => 'txtnodo_select_actual_all',
                    'listName' => 'txtnodo_select_actual'
                ])
                <br>
                <center>
                    <button onclick="consultarSeguimientoDeUnNodoFases('/seguimiento/seguimientoDeUnNodoFases/')" class="btn">Consultar</button>
                </center>
            </div>
        </ul>
