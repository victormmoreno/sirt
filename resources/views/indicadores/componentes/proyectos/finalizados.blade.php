<div class="row card card-panel teal lighten-5">
    <h6 class="font-bold">Para consultar los indicadores ÚNICAMENTE DE PROYECTOS FINALIZADOS Y CONCLUIDOS SIN FINALIZAR, debes seleccionar un rango de fechas y luego presionar el botón de descarga.</h6>
