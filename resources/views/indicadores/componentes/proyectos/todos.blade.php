<div class="row card-panel teal lighten-5">
    ...
    <div class="row">
        ...
        <div class="center input-field col s12 m6 l6">
            <a onclick="generarExcelConTodosLosIndicadores();" class="waves-effect waves-grey bg-secondary-lighten white-text btn-flat search-tabs-button m-l-xs">Descargar<i class="material-icons left">file_download</i></a>
        </div>
    </div>
</div>
