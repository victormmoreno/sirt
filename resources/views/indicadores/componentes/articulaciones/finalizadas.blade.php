<div class="row card card-panel teal lighten-5">
    <h6>Para consultar los indicadores ÚNICAMENTE DE ARTICULACIONES FINALIZADAS Y CONCLUIDAS SIN FINALIZAR, debes seleccionar un rango de fechas y luego presionar el botón de descarga.</h6>
    ...
    <div class="row">
        ...
        <div class="center input-field col s12 m6 l6">
            <a onclick="generarExcelIndicadoresArticulacionesFinalizadas();" class="btn"><i class="material-icons left">file_download</i>Descargar</a>
        </div>
    </div>
</div>
