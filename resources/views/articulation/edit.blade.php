        ...
        <div class="col s12">
            ...
            <div class="right right-align show-on-large hide-on-med-and-down">
                <ol class="breadcrumbs">
                    ...
                    <li class="active">{{__('Edit Accompaniment')}}</li>
                </ol>
            </div>
        </div>
        <div class="col s12 m12 l12">
            <div class="card mailbox-content">
                <div class="card-content">
                    <form method="POST" id="accompaniment-form" action="{{route('accompaniments.update', $accompaniment)}}"  accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        {!! method_field('PUT')!!}
                        <div>
