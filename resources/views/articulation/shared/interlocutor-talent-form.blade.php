        ...
        <div class="col s12 m12 l12">
            <div class="card card-transparent p f-12 m-t-lg">
                ...
                <div class="card-action">
                    <a target="_blank"  class="waves-effect waves-red btn-flat m-b-xs primary-text" href="{{route('usuarios.show',$articulationStage->interlocutor->documento)}}"><i class="material-icons left">link</i>Ver más</a>
                </div>
            </div>
        </div>
    @else
