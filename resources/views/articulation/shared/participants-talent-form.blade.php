                            ...
                            <div class="row card-talent{{$user->id}}">
                                <div class="col s12 m12 l12">
                                    <div class="card bs-dark ">
                                        <div class="card-content ">
                                            <span class="card-title p-h-lg  p f-12"> {{$user->present()->userDocumento()}} - {{$user->present()->userFullName()}}</span>
                                            <input type="hidden" name="talents[]" value="{{$user->id}}"/>
                                            <div class="position-top-right p f-12 mail-date hide-on-med-and-down no-m-b">  Acceso al sistema: {{$user->present()->userAcceso()}}</div>
                                        ...
                                        <div class="card-action">
                                            ...
                                            <a onclick="filter_project.deleteTalent({{$user->id}});" class="waves-effect waves-red btn-flat m-b-xs red-text"><i class="material-icons left"> delete_sweep</i>Eliminar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
