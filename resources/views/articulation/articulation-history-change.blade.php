                        ...
                        <li class="collection-item">
                            ...
                            <li class="collection-item">
                                @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsSolicitarTalento())
                                    El {{$traceability[$i]->rol}} {{$traceability[$i]->usuario}} {{$traceability[$i]->movimiento}} avalar el '{{$traceability[$i]->descripcion}}' de la {{__('articulation')}}
                                ...
                                @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento== App\Models\Movimiento::IsSolicitarDinamizador())
                                    ...
                                    el aval para '{{$traceability[$i]->descripcion}}' la {{__('articulation')}} en la fecha {{$traceability[$i]->created_at->isoFormat('MMMM Do YYYY, h:mm:ss a')}}
                                @endif
                                ...
                                @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsNoAprobar())
                                    El {{$traceability[$i]->rol}} {{$traceability[$i]->usuario}} {{$traceability[$i]->movimiento}}
                                    el aval para '{{$traceability[$i]->descripcion}}' la {{__('articulation')}}  en la fecha {{$traceability[$i]->created_at->isoFormat('MMMM Do YYYY, h:mm:ss a')}} por los siguientes motivos:  {{$traceability[$i]->comentarios}}
                                @endif
