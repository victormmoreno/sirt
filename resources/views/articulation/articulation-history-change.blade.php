                    ...
                    <ul class="collection">
                        ...
                        <li class="collection-item">
                            @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsSolicitarTalento())
                                El {{$traceability[$i]->rol}} {{$traceability[$i]->usuario}} {{$traceability[$i]->movimiento}} aprobar '{{$traceability[$i]->descripcion}}' de la {{__('articulation')}}
                            ...
                            @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento== App\Models\Movimiento::IsSolicitarDinamizador())
                                ...
                                {{$traceability[$i]->descripcion}} la {{__('articulation')}} en la fecha {{$traceability[$i]->created_at->isoFormat('MMMM Do YYYY, h:mm:ss a')}}
                            @endif
                            @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsAprobar())
                                El {{$traceability[$i]->rol}} {{$traceability[$i]->usuario}} {{$traceability[$i]->movimiento}}
                                la {{__('articulation')}} como {{$traceability[$i]->descripcion}} en la fecha {{$traceability[$i]->created_at->isoFormat('MMMM Do YYYY, h:mm:ss a')}}
                            @endif
                            @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsNoAprobar())
                                El {{$traceability[$i]->rol}} {{$traceability[$i]->usuario}} {{$traceability[$i]->movimiento}}
                                la {{__('articulation')}} como {{$traceability[$i]->descripcion}} en la fecha {{$traceability[$i]->created_at->isoFormat('MMMM Do YYYY, h:mm:ss a')}} por los siguientes motivos:  {{$traceability[$i]->comentarios}}
                            @endif
                            @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsRegistrar() || $traceability[$i]->movimiento == App\Models\Movimiento::IsCalificar())
                                ...
                                la {{__('articulation')}} {{$traceability[$i]->descripcion}}.
                            @endif
                            @if ( isset($traceability[$i]->usuario) && $traceability[$i]->movimiento == App\Models\Movimiento::IsAsignar())
                                ...
                                la {{__('articulation')}} al {{$traceability[$i]->rol}}  {{$traceability[$i]->descripcion}}.
                            @endif
