...
<body>
    ...
    <center>
        <p class="z-depth-3">
            <img src="http://drive.google.com/uc?export=view&id=1QLkYJuTk4JaT9nqHF7Rw6eF5p0G3or4C" class="img-responsive"
                width="342" height="89">
        </p>
    </center>
    <p>
        Señor(a) <br>
        <b>Nombres del contacto</b><br>
        Cordial Saludo
    </p>
    ...
    <p>
        Recuerde que además de la Asesoría Técnica para el Desarrollo de Proyectos de Base Tecnológica, la Red
        Tecnoparque Colombia pone a su disposición los siguientes servicios:
    </p>
    <ul>
    ...
    <center>
        <a><img src="https://i.ibb.co/M7vksPf/sennova.png" border="0" style="position: absolute; bottom: 0"
