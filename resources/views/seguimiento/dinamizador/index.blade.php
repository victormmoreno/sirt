          ...
          <div class="card-content">
            <div class="row">
              ...
              <div id="gestor" class="col s12 m12 l12">
                <div class="col s12 m12 l12">
                  <ul class="tabs tab-demo z-depth-1" style="width: 100%;">
                    <li class="tab col s3"><a class="" href="#gestor_proyectos">Proyectos</a></li>
                    <li class="tab col s3"><a class="" href="#gestor_articulaciones">Articulaciones G.I</a></li>
                  </ul>
                  <br>
                </div>
                <div id="gestor_proyectos" class="col s12 m12 l12">
                  <div class="row">
              ...
              <div id="tecnoparque" class="col s12 m12 l12">
                <div class="col s12 m12 l12">
                  <ul class="tabs tab-demo z-depth-1" style="width: 100%;">
                    <li class="tab col s3"><a class="" href="#tecnoparque_proyectos">Proyectos</a></li>
                    <li class="tab col s3"><a class="" href="#tecnoparque_articulaciones">Articulaciones G.I</a></li>
                    {{-- <li class="tab col s3"><a class="" href="#linea">Línea</a></li> --}}
                  </ul>
                  <br>
                </div>
                <div id="tecnoparque_proyectos" class="col s12 m12 l12">
                  <div class="row">
                    <div class="col s12 m4 l4">
                      <div class="row">
                        <div class="input-field col s12 m6 l6">
