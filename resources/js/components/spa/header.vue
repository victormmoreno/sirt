            ...
            <div class="nav-wrapper row">
              ...
              <div class="col s2 m3 l3 ">
                <a href="" class="hide-on-med-and-down">
                  <img class="hide-on-med-and-down"  width="200px" height="50px" v-bind:src="logo" ></img>
                </a>
              </div>
          ...
          <div class="side-nav-wrapper">
            <div class="sidebar-profile">
              <div class="sidebar-profile-info">
                <a href="">
                  <img  width="160px" height="40px" src="" class="show-on-small chapter-title"></img>
                </a>
            ...
            <a href="">
              <img  width="200px" height="60px" src="" class="chapter-title"></img>
            </a>
          </div>
...
<script >
	export default {
		data:  function() {
    		return{
		    	logo: 'img/logonacional_Blanco.png',
