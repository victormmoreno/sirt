...
return [
    ...
    'local'      => [
        ...
        ['name' => IngresoVisitanteTableSeeder::class, 'callable' => true],
        ['name' => EntrenamientosTableSeeder::class, 'callable' => true],
        ['name' => ComitesTableSeeder::class, 'callable' => true],
        ['name' => ComitesIdeasTableSeeder::class, 'callable' => true],
        ['name' => CharlasInformativasTableSeeder::class, 'callable' => true],
