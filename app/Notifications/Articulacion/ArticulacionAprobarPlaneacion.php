...
class ArticulacionAprobarPlaneacion extends Notification implements ShouldQueue
{
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'text'  => "El gestor ha solicitado aprobar la fase de planeación | {$this->getArticulacion()->articulacion_proyecto->actividad->codigo_actividad} - {$this->getArticulacion()->articulacion_proyecto->actividad->nombre}",
          ];
    }
