...
class NodoGestoresSheetExport extends FatherExport
{
    ...
    public function __construct($query, $nodo, $title)
    {
        ...
        $this->setCount(collect($this->getQuery())->count() + 7);
    ...
    {
        return view('exports.nodo.nodoGestores', [
            'gestores' => $this->getQuery()
        ]);
    }
