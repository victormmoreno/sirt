...
namespace App\Exports\User\Ingreso;
...
class IngresoUserExport extends FatherExport implements Responsable, WithDrawings
{

    use Exportable, createDrawingsExcel;

    private $fileName = 'Ingreso.xlsx';
    /**
    ...
    public function view(): View
    {
        ...
        return view('exports.users.ingreso.index', [
            'users' => $this->getQuery(),
        ]);
    }
