...
class ArticulacionRepository
{
    ...
    public function updateAprobacionDinamizador(int $id)
    {
        ...
        Notification::send(User::find($articulacion->asesor->id), new ArticulacionCierreAprobado($articulacion));
        $articulacion->articulacion_proyecto->actividad()->update([
    ...
    public function updateGestor($request, $id)
    {
        ...
        if ($articulacion->asesor_id != $request->txtgestor_id) {
    ...
    public function updateAprobacionSuspendido(int $id)
    {
        ...
        Notification::send(User::findOrFail($articulacion->asesor->id), new ArticulacionSuspendidoAprobado($articulacion));
        DB::commit();
        return true;
        } catch (\Throwable $th) {
        DB::rollback();
