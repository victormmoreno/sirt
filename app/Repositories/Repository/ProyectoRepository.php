...
class ProyectoRepository extends Repository
{
    ...
    public function proyectosIndicadoresSeparados_Repository()
    {
        ...
        ->selectRaw('(fecha_ejecucion) AS fecha_estimada_finalizacion_ejecucion')
        ->leftJoin('prorroga_proyecto as pro', function($q) {$q->on('pro.proyecto_id', '=', 'proyectos.id')->whereRaw('pro.created_at = (SELECT MAX(pp.created_at) FROM prorroga_proyecto AS pp)');})
    ...
    /**
     * Registra la fecha de terminación de ejecución de un proyecto
     *
     * @param Proyecto $proyecto
     * @param string $date
     * @return array
    ...
    /**
     * Reistra la fecha de ejecución de un proyecto
     *
     * @param Proyecto $proyecto
     * @param string $fecha
     * @return void
