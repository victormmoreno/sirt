...
class ArticulacionFaseInicioFormRequest extends FormRequest
{
    ...
    public function messages()
    {
        return $messages = [
            ...
            'txtnombre_convocatoria.max'                => 'El nombre del tipo de articulación debe ser máximo de 191 carácteres.',
            'txtnombre_convocatoria.min'                => 'El nombre del tipo de articulación debe ser minimo  de 2 carácteres.',
