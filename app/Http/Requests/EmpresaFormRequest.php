...
class EmpresaFormRequest extends FormRequest
{
    ...
    public function rules($sit = null)
    {
        return [
            ...
            'txtdireccion_sede' => Rule::requiredIf($sit != 'just_comp').'|max:100',
    ...
    public function messages()
    {
        return $messages = [
            ...
            'txtnit_empresa.min' => 'El nit de la empresa debe contener mínimo de 8 carácteres.',
            ...
            'txtdireccion_sede.required' => 'La dirección de la empresa es obligatoria.',
