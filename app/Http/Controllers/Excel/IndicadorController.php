...
use App\Repositories\Repository\{ProyectoRepository, UserRepository\TalentoRepository};
...
class IndicadorController extends Controller
{
  ...
  public function __construct(ProyectoRepository $proyectoRepository, TalentoRepository $talentoRepository)
  {
  ...
  public function exportIndicadores2020($idnodo, string $fecha_inicio, string $fecha_fin)
  {
    ...
    return Excel::download(new Indicadores2020Export($query, $queryTalentos), 'Indicadores.xls');
  }
